...
export function MacroPanel() {
  ...
  const items: MacroItem[] = [
    {
      ...
      change: <span style={{ color: mac.usdinr > 83.42 ? '#f04668' : '#27d17c' }}>
    ...
    },
    {
      ...
      change: <span style={{ color: vixChg >= 0 ? '#f04668' : '#27d17c' }}>
    ...
    },
    {
      ...
      change: <span style={{ color: mac.us10y > 4.28 ? '#f04668' : '#27d17c' }}>
    ...
    },
    {
      ...
      change: <span style={{ color: mac.dxy > 104.6 ? '#f04668' : '#27d17c' }}>
    ...
    },
    {
      ...
      change: <span style={{ color: mac.crude > 78.4 ? '#f04668' : '#27d17c' }}>
    ...
    },
    {
      ...
      change: <span style={{ color: mac.gold > 2318 ? '#27d17c' : '#f04668' }}>
  ...
  const fiiColor = mac.fii >= 0 ? '#27d17c' : '#f04668';
  const diiColor = mac.dii >= 0 ? '#27d17c' : '#f04668';
  const advRatio = mac.advance / (mac.advance + mac.decline);

  return (
    <div className="flex h-full flex-col justify-between gap-3 overflow-auto">
      {/* Macro grid */}
      <div className="grid grid-cols-2 gap-2">
        {items.map(({ label, value, change, color }) => (
          <div
            key={label}
            className="cell p-2.5"
          >
      ...
      <div className="cell p-3">
        ...
        <div className="mt-2 h-1.5 w-full overflow-hidden rounded-full bg-white/[0.05]">
          <motion.div
            ...
            style={{
              background: 'linear-gradient(90deg, #f04668, #27d17c)',
      ...
      <div className="cell p-3">
        ...
        <div className="flex items-center gap-3">
          <div>
            <div className="mono text-base font-bold text-[#27d17c]">
          ...
          <div className="flex-1 h-2 rounded-full overflow-hidden bg-white/[0.05]">
            <motion.div
              className="h-full rounded-full bg-gradient-to-r from-[#27d17c] to-[#f04668]"
          ...
          <div>
            <div className="mono text-base font-bold text-[#f04668]">
        ...
        <div className="mt-1 text-center text-[10px]"
          style={{ color: advRatio > 0.55 ? '#27d17c' : advRatio < 0.45 ? '#f04668' : 'var(--dim)' }}>
